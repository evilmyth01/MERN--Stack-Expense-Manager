  ...
  return (
    ...
    <div className="row mt-3">
        <div className='col-md-4'>
            <h4>Category Income</h4>
            {
                categories.map(category =>{
                    const amount = allTransactions.filter(transaction => transaction.category === category && transaction.type === "income").reduce((acc,transaction) => acc + transaction.amount,0)
                    return(
                        amount > 0 &&
                        <div className="card">
                            <div className="card-body">
        ...
        <div className='col-md-4'>
            ...
            {
                categories.map(category =>{
                    const amount = allTransactions.filter(transaction => transaction.category === category && transaction.type === "expense").reduce((acc,transaction) => acc + transaction.amount,0)
                    return(
                        amount > 0 &&
                        <div className="card">
                            <div className="card-body">
